...
var Urbit = class {
  ...
  async eventSource() {
    ...
    return new Promise((resolve, reject) => {
      fetchEventSource(this.channelUrl, __spreadProps(__spreadValues({}, this.fetchOptions), {
        openWhenHidden: true,
  ...
  async sendJSONtoChannel(...json) {
    const response = await fetch(this.channelUrl, __spreadProps(__spreadValues({}, this.fetchOptions), {
      method: "PUT",
  ...
  async poke(params) {
    const { app, mark, json, ship, onSuccess, onError } = __spreadValues({
      onSuccess: () => {
      },
      onError: () => {
      },
  ...
  async subscribe(params) {
    const { app, path, ship, err, event, quit } = __spreadValues({
      err: () => {
      },
      event: () => {
      },
  ...
  async thread(params) {
    ...
    const res = await fetch(`${this.url}/spider/${desk}/${inputMark}/${threadName}/${outputMark}.json`, __spreadProps(__spreadValues({}, this.fetchOptions), {
      method: "POST",
