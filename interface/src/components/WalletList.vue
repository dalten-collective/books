<template>
  ...
  <div
    :class="[pushWalletPending ? 'bg-gray-100 dark:bg-gray-400' : '']">
    <input type="text" placeholder="0xeee.111.222.333..." v-model="newAddress"/>
...
export default defineComponent({
  ...
  computed: {
    ...
    validAddress() {
      ...
      if (this.newNick === '' ) { return false; }
      if (!/^0x[a-fA-F0-9]{40}$/.test(this.newAddress)) { return false; }
      return true;
    },
  },
  methods: {
