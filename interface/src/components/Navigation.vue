  ...
  <ul class="list-reset flex flex-row text-center md:flex-col md:text-left">
    <li class="mr-3 flex-1">
      <router-link :to="{ name: 'home' }">
        <div
          class="align-left hover:text-pink border-grey-darkest hover:border-pink block border-b-2 py-1 pl-1 text-neutral-900 no-underline md:border-black md:py-3"
        >
    ...
    <li class="mr-3 flex-1">
      <router-link :to="{ name: 'wallets' }">
        <div
          class="my-6 flex items-center p-2 transition-colors duration-200 hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-600 dark:hover:text-white"
          v-bind:class="[
            nav === 1
        ...
        >
          ...
          <span class="mx-4 text-lg font-normal"> Wallets </span>
    ...
    <li class="mr-3 flex-1">
      <router-link :to="{ name: 'transactions' }">
        ...
        >
          ...
          <span class="mx-4 text-lg font-normal"> Ledger </span>
          <span class="flex-grow text-right"> </span>
        </div>
      </router-link>
    </li>
    <li class="mr-3 flex-1">
      ...
      >
        ...
        <span class="mx-4 text-lg font-normal"> Rolodex </span>
        <span class="flex-grow text-right"> </span>
      </a>
    </li>
    <li class="mr-3 flex-1">
      <a
        class="flex items-center py-2 px-8 text-gray-600 transition-colors duration-200 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100"
        href="#"
      >
        <svg
          width="20"
