...
import { pushAnnotation, clearAnnotation } from '@/api/books.ts';
    ...
    const onSubmit = () => {
      ...
      formRef.value
        ...
        .then(() => {
          ...
          const regex = /\s+/g;
          console.log('new-tag', newTag.value);
          const tNew = newTag.value
            .split(',')
            .slice()
          ...
          console.log('tags', tNew);
          console.log('toRaw', formState.basis, toRaw(formState.basis));
